...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/Etudiant', [participantController::class, 'viewFormParticipant'])->name('Enregistrement.Etudiant');
    ...
    Route::post('/add-participant', [participantController::class, 'addParticipant']);
