!function ($) {
    ...
    SweetAlert.prototype.init = function () {
        ...
        //Success Message
        $('#sa-success-auther').click(function () {
            swal(
                {
            ...
            swal(
                {
                    type: 'error',
                    title: 'Oops...',
                    text: 'Vous ne pouvez pas supprimmer cet expediteur car il est lier a des marchandes',
                }
            )
        });
        ...
        //Auto Close Timer
        $('#sa-connexion').click(function () {
            swal({
                title: 'Info',
                text: 'La marchandise a ete correctement enregistrer, mais Le Qr code n\' pas pue etre correctment generer',
                type: 'warning',
                timer: 7000
            }).then(
                function () {
