					...
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								...
								><span class="mtext">Etudiants</span>
							</a>
							<ul class="submenu">
								<li>
									<a href="{{route('Enregistrement.Etudiant')}}">Enregistrements</a>
								</li>
								<li><a href="form-wizard.html">Listes etudiants</a></li>
							</ul>
						</li>
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
						...
						<li>
							<a href="calendar.html" class="dropdown-toggle no-arrow">
								...
								><span class="mtext">Formateurs</span>
							</a>
						</li>
						<li>
							<a href="calendar.html" class="dropdown-toggle no-arrow">
								<span class="micon bi bi-receipt-cutoff"></span
								><span class="mtext">Session de formation</span>
							</a>
						</li>
						<li>
							<a href="calendar.html" class="dropdown-toggle no-arrow">
						...
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								...
								><span class="mtext">Evaluations</span>
							</a>
							<ul class="submenu">
						...
						<li>
							<a href="calendar.html" class="dropdown-toggle no-arrow">
								<span class="micon bi bi-receipt-cutoff"></span
								><span class="mtext">Revelever de note</span>
							</a>
						</li>
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								<span class="micon bi bi-archive"></span
								><span class="mtext">Payements</span>
							</a>
							<ul class="submenu">
						...
						<li>
							<a href="calendar.html" class="dropdown-toggle no-arrow">
								<span class="micon bi bi-receipt-cutoff"></span
								><span class="mtext">Badges</span>
							</a>
						</li>
						<li>
							<a href="calendar.html" class="dropdown-toggle no-arrow">
								<span class="micon bi bi-receipt-cutoff"></span
								><span class="mtext">Attestations</span>
							</a>
						</li>
						@endif
