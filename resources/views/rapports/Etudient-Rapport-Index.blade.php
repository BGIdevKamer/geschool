    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-100px">
            <div class="page-header">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="title">
                            <h4>Rapport @if(Session::get('type') == "1" OR Session::get('type') == "2") Elèves @else Etudiants @endif</h4>
                        </div>
            ...
            <div class="pd-20 card-box mb-30">
                <h3 class="m-3 text-primary">Rapport @if(Session::get('type') == "1" OR Session::get('type') == "2") Elèves @else Etudiants @endif</h3>

                <form action="{{route('Etudient.RapportCreate')}}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
