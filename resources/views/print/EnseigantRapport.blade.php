    ...
    <section class="wrapper-invoice">
        ...
        <div class="invoice">
            ...
            <table class="header-table" style="border-collapse: collapse;">
                <th>
                <td>
                    <h2 style="text-decoration: underline; text-transform: uppercase;">Liste des Enseignants</h2>
                </td>
                </th>
            </table>
            <br>
            <div class="invoice-body">
                <table class="table">
                    <thead>
                        ...
                        <td style="background-color:rgb(233, 233, 233);padding: 7px 0px;text-align: center;">Telephone</td>
                        <td style="background-color:rgb(233, 233, 233);padding: 7px 0px;text-align: center;">Email</td>
                    </thead>
                    @foreach($Enseigants as $Enseigant)
                    <tr>
                        <td style="font-weight: 200;font-size: 14px;text-align: center;padding: 2px 0px;">{{$Enseigant->nom}}</td>
                        <td style="font-weight: 200;font-size: 14px;text-align: center;padding: 2px 0px;">{{$Enseigant->prenom}}</td>
                        <td style="font-weight: 200;font-size: 14px;text-align: center;padding: 2px 0px;">{{$Enseigant->phone}}</td>
                        <td style="font-weight: 200;font-size: 14px;text-align: center;padding: 2px 0px;">{{$Enseigant->email}}</td>
                    </tr>
                    @endforeach
                </table>
            </div> <br> <br>
