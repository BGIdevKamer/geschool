    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            <a href="" class="navbar-brand p-0">
                <h1 class="text-primary">Twheystats</h1>
    ...
    <div class="container-fluid service pb-5">
        <div class="container pb-5">
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                <h4 class="text-primary">Our Formation</h4>
                <h1 class="display-5 mb-4">The best formation</h1>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="service-item">
                        <div class="service-img">
                            <img src="{{Storage::url($formation->img)}}" class="img-fluid rounded-top w-100" alt="Image">
                        </div>
                        <div class="rounded-bottom p-4">
                            <a href="#" class="h4 d-inline-block mb-4">{{$formation->nom}}</a>
                            <p class="mb-4">
                                {{$formation->note}}
                            </p>
                            <a class="btn btn-primary rounded-pill py-2 px-4" href="#">S'inscrire</a>
                        </div>
                    </div>
                </div>
                @endforeach
