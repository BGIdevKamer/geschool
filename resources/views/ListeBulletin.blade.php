            ...
            <div class="col-md-6 col-sm-12 text-right">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="{{route('download.all',['evaluation'=>$data[0]['evaluation'],'formation'=>$data[0]['formation'],'anneeScolaire'=>$data[0]['anneeScolaire']])}}">Telecharger Tout</a>
                        <a class="dropdown-item" href="{{route('delete.all',['evaluation'=>$data[0]['evaluation'],'formation'=>$data[0]['formation'],'anneeScolaire'=>$data[0]['anneeScolaire']])}}">Supprimer Tout</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <table class="data-table table nowrap">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$Bulletin->anneeScolaire}}</td>
                    <td>{{$Bulletin->Evaluation->libeller}}</td>
                    <!-- <td>
                        <span
