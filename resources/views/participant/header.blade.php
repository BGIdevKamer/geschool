            ...
            <div class="user-info-dropdown">
                <div class="dropdown">
                    <a
                        ...
                        <span class="user-name">{{Auth()->guard('participant')->user()->nom}} {{Auth()->guard('participant')->user()->prenom}}</span>
                    </a>
                    <div
        ...
        <div class="menu-block customscroll">
            <div class="sidebar-menu">
                <ul id="accordion-menu">
                    ...
                    <li>
                        <a href="calendar.html" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-receipt-cutoff"></span><span class="mtext">Support</span>
                        </a>
                    </li>
                    <li>
                        <a href="calendar.html" class="dropdown-toggle no-arrow">
